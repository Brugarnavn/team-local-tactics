...
class Champion:
    ...
    def __str__(self) -> str:
        return " ".join([self.name, str(self._rock), str(self._paper), str(self._scissors)])
...
class Match:
    ...
    def play(self):
        ...
        for round in self._rounds:
            for red_champ, blue_champ in zip(self.red_team.champions, self.blue_team.champions):
                print(red_champ, blue_champ)
